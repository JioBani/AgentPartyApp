...
> 2026-08-13 갱신: DeepSeek V4 Pro 는 0813 GA 스냅샷 기준으로 가격 동일(0.435/0.87, 캐시히트 0.003625)함을 실호출로 재확인.
> 단 DeepSeek 이 "가까운 시일 내 대폭 인상"을 공지했고, OR 의 `deepseek/deepseek-v4-pro-0813` 은 자사 엔드포인트뿐이라 엄격한 데이터 정책 계정에서는 차단된다(무날짜 id 는 제3자 호스트로 통과, 단 가격 1.168/2.336).

...
assert(L.pruneLayout(browserLayout, new Set(["main", browserTab])).panels.length === 2, "valid browser tab survives layout restoration");
assert(L.pruneLayout(browserLayout, new Set(["main"])).panels.length === 1, "removed browser tab is pruned without removing chat");

...
assert(!invalidBaiCreate.ok && /Use: low, high, max/.test(invalidBaiCreate.error || ""), "member-create rejects an explicit effort the selected B.AI model does not advertise");

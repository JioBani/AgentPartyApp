...
const initialState = {
  ok: true,
  settings: { workspacePath: "/dev/acme-api", claudeExecutablePath: "", museExecutablePath: "", claudeSafeMode: false, selectedHarnessId: "claude-code", harnessDefaults: { "claude-code": { model: "claude-sonnet-4.5", effort: "high", permissionMode: "default" }, codex: { model: "gpt-5.5", effort: "medium", codexPolicy: { sandbox: "workspace-write", approval: "on-request", guardian: false } }, cursor: { model: "auto", effort: "" }, grok: { model: "grok-4.7", effort: "high", permissionMode: "default" }, muse: { model: "muse-default", effort: "high", permissionMode: "default" } }, debugEnabled: false, routerBaseUrl: "", routerAuthToken: "", openRouterApiKey: "", automationApiPort: 47831,

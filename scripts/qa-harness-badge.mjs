...
assert(wide.querySelectorAll('.wb-tab .wb-member-mark svg[data-vendor-mark]').length === 3, "providers we hold artwork for render their vector brand mark");
assert(wide.querySelector('.wb-tab .wb-member-mark svg[data-vendor-mark="openrouter"]'), "OpenRouter uses its own vector mark, not a blank slot or another company's logo");
assert(wide.querySelectorAll('.wb-tab .wb-provider-icon-generic').length === 0, "every provider in this fixture has a dedicated mark");

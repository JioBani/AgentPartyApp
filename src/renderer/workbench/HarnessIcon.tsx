...
/**
 * Official harness marks under one AgentParty presentation contract.
 *
 * Claude Spark and OpenAI Blossom preserve the published vector geometry.
 * Cursor preserves its official 2.5D outer/fold geometry while reducing the
    ...
    return (
      <svg {...common} viewBox="0 0 466.73 533.32">
        ...
        <g mask={`url(#${cursorMaskId})`}>
          ...
          <path className="wb-harness-icon-tone" d="M448.35 142.54a7.75 7.75 0 0 1 0 7.74L238.52 513.7c-1.41 2.46-5.16 1.45-5.16-1.38V272.84c0-1.91-.51-3.75-1.44-5.36l216.42-124.95Z" />
        </g>
      </svg>
    );
  }

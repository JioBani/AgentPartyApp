...
export function createFakeAgentParty(): FakeAgentParty {
  ...
  const api: AgentPartyApi = {
    ...
    reorderPartiesInGroup: () => refused(),
    removePartyGroup: () => refused(),
    getCwdPreferences: () => Promise.resolve({ ok: true as const, preferences: { windowsRecent: [], wslRecent: [], sshRecent: [] } }),
    ...
    listSshServers: () => Promise.resolve([]),
    onSshServers: (callback) => subscribe(callback),
    onSshAttempt: (callback) => subscribe(callback),
    sshConnectDraft: () => refused(),
    sshTrustFingerprint: () => refused(),
    sshCancelAttempt: () => refused(),
    sshSetupAutoLogin: () => refused(),
    sshContinueWithPassword: () => refused(),
    sshSavePasswordLogin: () => refused(),
    sshRetest: () => refused(),
    sshPickKeyFile: () => refused(),
    sshInspectKeyFile: () => refused(),
    sshTestServer: () => refused(),
    sshReconnect: () => refused(),
    sshTrustNewFingerprint: () => refused(),
    sshDeleteServer: () => refused(),
    sshCopyPublicKey: () => refused(),
    sshCheckRemotePath: () => refused(),
    sshRemoteHome: () => refused(),
    sshListRemoteDirectories: () => refused(),
    sshSuggestRemotePaths: () => refused(),
